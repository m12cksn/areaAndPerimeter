...
const QUESTIONS = [
  {
    id: 1,
    type: "mcq",
    title: "Count the rainbows",
    text: "🌈 🌈 🌈 🌈 🌈 🌈",
    options: ["5", "6", "7", "8"],
    correct: "6",
    explanation: "There are six rainbows.",
  },
  {
    id: 2,
    type: "mcq",
  ...
  },
  {
    ...
    options: ["6", "7", "8", "9"],
    correct: "8",
    explanation: "There are eight rockets.",
  },
  {
    id: 5,
    type: "mcq",
    title: "Missing number to 10",
    text: "4 + ? = 10",
    options: ["5", "6", "7", "8"],
    correct: "6",
    explanation: "4 + 6 = 10.",
  },
  {
    id: 6,
    type: "mcq",
    title: "Take away balloons",
    text: "🎈🎈🎈🎈🎈🎈 🎈🎈 − 🎈🎈🎈 = ?",
    options: ["3", "4", "5", "6"],
    correct: "5",
    explanation: "8 balloons − 3 balloons = 5.",
  },
  {
    id: 7,
    type: "mcq",
    title: "Which group has 9?",
    text: "Choose the group with 9 objects.",
    options: [
      "🍌🍌🍌🍌🍌",
      "🍓🍓🍓🍓🍓🍓🍓🍓🍓",
      "⚽⚽⚽⚽⚽⚽",
    ...
    correct: "🍓🍓🍓🍓🍓🍓🍓🍓🍓",
    explanation: "The strawberries group shows 9.",
  },
  {
    id: 8,
    type: "mcq",
  ...
  },
  {
    ...
    options: ["8", "9", "10", "11"],
    correct: "9",
    explanation: "6 dogs + 3 cats = 9 animals.",
  },
  {
    id: 10,
    type: "mcq",
    title: "Take away to get 4",
    text: "10 − ? = 4",
    options: ["5", "6", "7", "8"],
    correct: "6",
    explanation: "10 − 6 = 4.",
  },
  {
    ...
    options: ["10", "11", "12", "13"],
    correct: "12",
    explanation: "There are 12 hearts.",
  },
  {
    id: 12,
    type: "mcq",
  ...
  },
  {
    id: 13,
    type: "mcq",
    title: "Smaller or bigger?",
    text: "Which number is bigger?",
    options: ["8", "6", "4", "3"],
    correct: "8",
    explanation: "8 is the biggest number in the list.",
  },
  {
    id: 14,
    type: "mcq",
    title: "Count the stars quickly",
    text: "⭐ ⭐ ⭐ ⭐ ⭐ ⭐ ⭐ ⭐ ⭐ ⭐",
    options: ["8", "9", "10", "12"],
    correct: "10",
    explanation: "There are 10 stars.",
  },
  {
    id: 15,
    type: "mcq",
    title: "Make 12 with 5",
    text: "5 + ? = 12",
    options: ["6", "7", "8", "9"],
    correct: "7",
    explanation: "5 + 7 = 12.",
  },
  {
    ...
    options: ["4", "5", "6", "7"],
    correct: "6",
    explanation: "9 apples − 3 apples = 6.",
  },
  {
    id: 17,
    type: "mcq",
    title: "Which shows 8?",
    text: "Pick the group that shows 8.",
    options: [
      "🐠🐠🐠🐠🐠",
      "🐠🐠🐠🐠🐠🐠🐠🐠",
      "🐠🐠🐠🐠",
    ...
    correct: "🐠🐠🐠🐠🐠🐠🐠🐠",
    explanation: "The second group has 8 fish.",
  },
  {
    id: 18,
    type: "mcq",
    title: "Two-step subtraction",
    text: "12 − 3 − 2 = ?",
    options: ["6", "7", "8", "9"],
    correct: "7",
    explanation: "12 − 3 = 9; 9 − 2 = 7.",
  },
  {
    id: 19,
    type: "mcq",
    title: "Close to 10",
    text: "Which number is just 1 less than 10?",
    options: ["8", "9", "10", "11"],
    correct: "9",
    explanation: "9 is 1 less than 10.",
  },
  {
    id: 20,
    type: "mcq",
    title: "Add different groups",
    text: "There are 4 ⚽ balls and 5 🏀 balls. How many balls in total?",
    options: ["7", "8", "9", "10"],
    correct: "9",
    explanation: "4 + 5 = 9 balls.",
  },
];
