...
const DATA = {
  ...
  description:
    "Latihan lanjutan konversi, operasi, dan soal cerita pecahan, desimal, dan persen.",
  questions: [
    {
      id: "q1",
      type: "short_answer",
      question: "Ubah pecahan 3/8 ke bentuk desimal = ...",
      answer: "0,375",
    ...
    },
    {
      ...
      question: "0,045 setara dengan ...",
      choices: ["4,5%", "0,45%", "45%", "0,045%"],
      answer: "4,5%",
      explanation: "0,045 = 4,5%.",
    },
    {
      id: "q3",
      type: "short_answer",
      question: "75% dari 360 adalah ...",
      answer: "270",
      explanation: "75% = 3/4, jadi 3/4 × 360 = 270.",
    },
    {
      id: "q4",
      type: "short_answer",
      ...
      answer: "1/2",
      explanation: "1/3 = 2/6, jadi 5/6 − 2/6 = 3/6 = 1/2.",
    },
    {
      id: "q5",
      type: "multiple_choice",
      question: "Pecahan yang setara dengan 0,875 adalah ...",
      choices: ["7/8", "3/4", "5/6", "9/10"],
      answer: "7/8",
    ...
    },
    {
      id: "q6",
      type: "short_answer",
      question: "Ubah 2 1/5 ke desimal = ...",
      answer: "2,2",
      explanation: "2 1/5 = 2 + 0,2 = 2,2.",
    },
    {
      id: "q7",
      type: "short_answer",
      question: "Hitung: 0,48 ÷ 0,6 = ...",
      answer: "0,8",
    ...
    },
    {
      id: "q8",
      type: "short_answer",
      question: "Harga awal Rp240.000 naik 12,5%. Harga baru = ...",
      answer: "270000",
      explanation:
        "12,5% dari 240.000 = 30.000, jadi 240.000 + 30.000 = 270.000.",
    },
    {
      id: "q9",
      type: "multiple_choice",
      question: "0,3% setara dengan pecahan ...",
      choices: ["3/1000", "3/100", "30/1000", "0,3/100"],
      answer: "3/1000",
      explanation: "0,3% = 0,003 = 3/1000.",
    },
    {
      id: "q10",
      type: "short_answer",
      question: "Ubah 7/20 ke persen = ...",
      answer: "35%",
    ...
    },
    {
      ...
      type: "story_problem",
      question:
        "Sebuah tangki terisi 3/5. Setelah ditambah 18 liter, terisi 85% dari kapasitas. Kapasitas tangki = ... liter",
      answer: "72",
      explanation: "0,85x − 0,6x = 0,25x = 18, jadi x = 72.",
    },
    {
      id: "q12",
      type: "story_problem",
      question:
        "Nilai ujian naik dari 64 ke 80. Kenaikan dalam persen = ...",
      answer: "25%",
      explanation: "Kenaikan 16 dari 64, jadi 16/64 = 0,25 = 25%.",
    },
    {
      id: "q13",
      type: "short_answer",
      question: "Ubah 0,125 ke pecahan paling sederhana = ...",
      answer: "1/8",
    ...
    },
    {
      id: "q14",
      type: "multiple_choice",
      question: "Hasil 1/4 + 0,35 adalah ...",
      choices: ["0,6", "0,55", "0,75", "0,85"],
      answer: "0,6",
      explanation: "1/4 = 0,25, jadi 0,25 + 0,35 = 0,6.",
    },
    {
      id: "q15",
      type: "short_answer",
      question: "Jika 40% dari suatu bilangan adalah 96, bilangan itu = ...",
      answer: "240",
      explanation: "40% = 0,4, jadi 96 ÷ 0,4 = 240.",
    },
  ],
};
